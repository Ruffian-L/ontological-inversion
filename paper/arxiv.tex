...
plot receipts are in \url{paper/receipts/}. Ordered-slot transcripts and layer
tapes remain under \url{niodoo-live/synapse/} (the later generator-side writes).
Run cards are under \url{runs/}; subject logs are under \url{research_logs/}.
